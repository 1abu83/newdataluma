...
export default function StopLimitOrderForm({ type, selectedAsset }: StopLimitOrderFormProps) {
  ...
  function onSubmit(data: z.infer<typeof FormSchema>) {
    toast({
      ...
      description: `Your ${type} order for ${data.amount} ${assetName} with stop at ${data.stopPrice.toFixed(2)} ${currencyName} and limit at ${data.limitPrice.toFixed(2)} ${currencyName} has been placed. (Feature is for UI demo only)`,
    })
    form.reset()
  }
